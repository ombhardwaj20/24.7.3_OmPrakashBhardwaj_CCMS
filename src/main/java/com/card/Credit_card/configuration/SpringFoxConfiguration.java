package com.card.Credit_card.configuration;
...
public class SpringFoxConfiguration {
    ...
    public Docket api() {
        return new Docket(DocumentationType.OAS_30).select()
                .apis(RequestHandlerSelectors.basePackage("com.credit.cred")).build()
    ...
    private ApiInfo apiInfo() {
        ...
        Contact contact = new Contact("Prakash", "https://harikesh409.github.io/",
